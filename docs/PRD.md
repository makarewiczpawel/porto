...
| 4 | **Nawis powtórek po przerwie.** Tydzień urlopu = 300 kart `due` i zniechęcenie | Średni | Twardy `review_limit` w sesji + sortowanie po `due` rosnąco; po dłuższej przerwie tryb „nadrabianie" rozkłada zaległości na plan z terminem, który się odlicza | Otwarte |
